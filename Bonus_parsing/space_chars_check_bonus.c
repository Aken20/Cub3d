...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   space_chars_check_bonus.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: suibrahi <suibrahi@student.42.fr>          +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/11 04:01:43 by suibrahi          #+#    #+#             */
/*   Updated: 2024/09/11 04:09:59 by suibrahi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	check_unwanted_chars(t_map *map_data)
{
	...
	while (map_data->file[++vars.y])
	{
		...
		if (map_data->file[vars.y][vars.x] != '\0')
		{
			if (ft_strncmp(map_data->file[vars.y], "NO", 2) != 0
				&& ft_strncmp(map_data->file[vars.y], "SO", 2) != 0
				&& ft_strncmp(map_data->file[vars.y], "WE", 2) != 0
				&& ft_strncmp(map_data->file[vars.y], "EA", 2) != 0
				&& ft_strncmp(map_data->file[vars.y], "C", 1) != 0
				&& ft_strncmp(map_data->file[vars.y], "F", 1) != 0
