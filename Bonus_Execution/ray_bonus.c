...
/*   Updated: 2024/09/10 03:25:41 by ahibrahi         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (data->door_flag > 40000)
		data->door_flag = 0;
	if (data->door_flag <= 0)
		draw_wall(data, is_vert, line_height, data->door[0]);
	else if (data->door_flag > 10000 && data->door_flag < 20000)
		draw_wall(data, is_vert, line_height, data->door[2]);
	else if (data->door_flag >= 1 && data->door_flag <= 10000)
	{
		draw_wall(data, is_vert, line_height, data->door[1]);
		data->door_flag++;
	}
	else if (data->door_flag >= 30000 && data->door_flag <= 40000)
	{
		draw_wall(data, is_vert, line_height, data->door[1]);
		data->door_flag++;
	}
...
// 				draw_wall(data, is_vert, line_height, data->door[3]);
...
// 		}
// 		else if (data->r_angle > 90 && data->r_angle < 270)
// 			draw_wall(data, is_vert, line_height, data->W_Wall);
// 		else
// 			draw_wall(data, is_vert, line_height, data->E_Wall);
// 	}
// 	else
// 	{
// 		x_m = floor ((int)data->hx / data->map->pixel);
...
// 		}
// 		else if (data->r_angle > 0 && data->r_angle < 180)
// 			draw_wall(data, is_vert, line_height, data->N_Wall);
// 		else
// 			draw_wall(data, is_vert, line_height, data->S_Wall);
// 	}
// }
